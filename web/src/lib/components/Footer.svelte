...
<footer id="footer" class="background-bg0" style="border: none; margin: 0px; padding-top: 1rem; padding-bottom: 8rem;">
    ...
    <div style="text-align: start; padding: 0px 2rem">
      <p>
        v0.29.0 · <a href="https://codeberg.org/ehanahamed/quizfreely/releases">Changelog (on Codeberg)</a> or <a href="https://github.com/ehanahamed/quizfreely/releases">on GitHub</a>
      </p>
      <p>
